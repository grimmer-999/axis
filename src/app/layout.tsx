...
const SITE_URL = "https://axis.live";
const SITE_NAME = "AXIS";
const SITE_TITLE = "AXIS — Open Source globe Platform | Live Flight Tracking, CCTV,";
...
export const metadata: Metadata = {
  ...
  title: {
    default: SITE_TITLE,
    template: "%s | AXIS Intelligence",
  },
  description: SITE_DESCRIPTION,
  keywords: [
    // OSINT Tools - Primary focus
    "AXIS tools", "free AXIS tools", "online OSINT toolkit", "OSINT framework",
  ...
  authors: [{ name: "axis Project", url: SITE_URL }],
  creator: "axis Project",
  publisher: "axis Project",
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "AXIS — The Open-Source Palantir Alternative | Live Flights, CCTV, Satellites & OSINT Tools",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "AXIS — Open Source Intelligence Platform with Live Tracking & OSINT Tools",
        type: "image/png",
      },
    ],
  },
  twitter: {
    ...
    title: "🛰️ AXIS — Open Source Palantir Alternative | Live Tracking + OSINT Tools",
